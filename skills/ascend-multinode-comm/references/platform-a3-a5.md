...
平台扩展不以提供大量脚本为前提。先从 [官方配方索引](official-deployment-recipes.md) 选匹配版本的 A3/A5 混部、PD 分离、池化参考，再按 [成功部署样本指引](known-good-deployments.md) 补充现场变体。官方与现场证据分开，A2 示例不能换个标签充当 A3/A5 成功；仅在真实覆盖的组合内提炼经验。
